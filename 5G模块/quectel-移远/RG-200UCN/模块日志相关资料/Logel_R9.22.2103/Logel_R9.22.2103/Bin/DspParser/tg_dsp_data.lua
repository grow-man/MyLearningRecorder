...
function func_D000(address, data, name)	--Demo tg rat single address function
	return data
end

function func_D000D0001(addressL, dataL, nameL, addressH, dataH, nameH)   --Demo tg rat double address function
	return bit.lshift(dataH,16) +dataL
end
